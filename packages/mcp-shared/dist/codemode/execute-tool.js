...
export function createExecuteTool(options) {
    const { prefix, catalog, openApiSpec, apiFetch, doNamespace, loader: rawLoader, stagingThreshold, timeout = 30_000, preamble, fsDoNamespace, } = options;
     ...
     */
    function buildExecutorFns(sessionId) {
